...
const javabasicContentData = `<ul>
<li><a href="#java-interview-question-bank">Java Interview Question Bank</a></li>
<li><a href="#java-principles--best-practices--memory-management">Java Principles &amp; Best Practices , Memory Management</a></li>
<li><a href="#java-memory-management-principles">Java Memory Management Principles</a></li>
<li><a href="#-primary-main-features-of-java">🚀 Primary Main Features of Java</a></li>
<li><a href="#javas-main-features-with-examples">Java&#x27;s Main Features (with Examples)</a></li>
<li><a href="#-class-loaders-in-java">🧩 Class Loaders in Java</a></li>
<li><a href="#1-bootstrap-class-loader">1. Bootstrap Class Loader</a></li>
<li><a href="#2-extension-class-loader">2. Extension Class Loader</a></li>
<li><a href="#3-systemapplication-class-loader">3. System/Application Class Loader</a></li>
<li><a href="#java-class-loaders-simple--clear">Java Class Loaders (Simple &amp; Clear)</a></li>
<li><a href="#-identifiers-in-java">🆔 Identifiers in Java</a></li>
<li><a href="#some-java-keywords">Some Java Keywords</a></li>
<li><a href="#java-identifiers-short--simple">Java Identifiers (Short &amp; Simple)</a></li>
<li><a href="#-what-is-a-class">🏷️ What is a Class?</a></li>
<li><a href="#-common-types-of-classes-in-java">🏗️ Common Types of Classes in Java</a></li>
<li><a href="#1-regular-concrete-class">1. Regular (Concrete) Class</a></li>
<li><a href="#2-abstract-class">2. Abstract Class</a></li>
<li><a href="#3-interface">3. Interface</a></li>
<li><a href="#4-final-class">4. Final Class</a></li>
<li><a href="#5-inner-class">5. Inner Class</a></li>
<li><a href="#6-static-nested-class">6. Static Nested Class</a></li>
<li><a href="#7-anonymous-class">7. Anonymous Class</a></li>
<li><a href="#-example-of-anonymous-class">🧩 Example of Anonymous Class</a></li>
<li><a href="#-common-java-terms">📚 Common Java Terms</a></li>
<li><a href="#java-constructors">Java Constructors</a></li>
...
<li><a href="#4-constructor-chaining">4. Constructor Chaining</a></li>
<li><a href="#5-private-constructor">5. Private Constructor</a></li>
<li><a href="#private-class-vs-private-constructor">Private Class vs Private Constructor</a></li>
<li><a href="#example-private-class">Example: Private Class</a></li>
<li><a href="#example-private-constructor-singleton">Example: Private Constructor (Singleton)</a></li>
<li><a href="#-1-constructor-chaining">🧩 <strong>1️⃣ Constructor Chaining</strong></a></li>
<li><a href="#-2-method-chaining-fluent-interface">🧱 <strong>2️⃣ Method Chaining (Fluent Interface)</strong></a></li>
<li><a href="#-basic-example">🔹 Basic Example</a></li>
<li>[🔹 Real-world Example: <code>StringBuilder</code>](#-real-world-example-stringbuilder)</li>
<li><a href="#-another-example-streams-api">🔹 Another Example: Streams API</a></li>
<li><a href="#-3-builder-pattern-chaining-for-object-construction">🧩 <strong>3️⃣ Builder Pattern (Chaining for Object Construction)</strong></a></li>
<li><a href="#example">Example:</a></li>
<li><a href="#-4-stream-chaining--functional-chaining">⚙️ <strong>4️⃣ Stream Chaining / Functional Chaining</strong></a></li>
<li><a href="#-5-operator--dsl-style-chaining">🧠 <strong>5️⃣ Operator / DSL-style Chaining</strong></a></li>
<li><a href="#-6-other-types-of-chaining-concepts">⚡ <strong>6️⃣ Other Types of “Chaining” Concepts</strong></a></li>
<li><a href="#-7-pitfalls--best-practices">⚠️ <strong>7️⃣ Pitfalls / Best Practices</strong></a></li>
<li><a href="#-summary">✅ <strong>Summary</strong></a></li>
<li><a href="#-tldr">🔑 TL;DR</a></li>
<li><a href="#-which-one-should-you-use">📊 Which One Should You Use?</a></li>
<li><a href="#modifiers-in-java">Modifiers in Java</a></li>
<li><a href="#1-access-modifiers">1. Access Modifiers</a></li>
<li><a href="#details">Details</a></li>
<li><a href="#example-of-private-modifier">Example of Private Modifier</a></li>
<li><a href="#private-constructor">Private Constructor</a></li>
<li><a href="#2-non-access-modifiers">2. Non-Access Modifiers</a></li>
<li>[<code>static</code> Modifier](#static-modifier)</li>
<li><a href="#-key-points-about-static-blocks">✅ Key Points about Static Blocks:</a></li>
<li><a href="#-example">📌 Example:</a></li>
<li><a href="#-common-uses">⚡ Common Uses:</a></li>
<li>[<code>final</code> Modifier](#final-modifier)</li>
<li>[<code>abstract</code> Modifier](#abstract-modifier)</li>
<li>[<code>native</code> Modifier](#native-modifier)</li>
<li><a href="#summary-table">Summary Table</a></li>
<li><a href="#strings-in-java">Strings in Java</a></li>
<li><a href="#string-vs-stringbuffer-vs-stringbuilder-vs-string-pool">String vs StringBuffer vs StringBuilder vs String Pool</a></li>
<li><a href="#string-vs-stringbuffer-vs-stringbuilder">String vs StringBuffer vs StringBuilder</a></li>
<li><a href="#string-pool">String Pool</a></li>
<li><a href="#memory-areas-related-to-strings">Memory Areas Related to Strings</a></li>
<li><a href="#memory-areas-related-to-strings-1">Memory Areas Related to Strings</a></li>
<li><a href="#memory-areas-explained">Memory Areas Explained</a></li>
<li><a href="#interning-and-string-pool">Interning and String Pool</a></li>
<li><a href="#example-1">Example</a></li>
<li><a href="#summary-table-1">Summary Table</a></li>
<li><a href="#-java-memory-spaces-jvm-memory-structure">🧠 Java Memory Spaces (JVM Memory Structure)</a></li>
<li><a href="#-flow-diagram-markdown-text-format">🔁 Flow Diagram (Markdown Text Format)</a></li>
<li><a href="#-jvm-memory-areas-explained">🧩 JVM Memory Areas Explained</a></li>
<li><a href="#1-heap">1. <strong>Heap</strong></a></li>
<li><a href="#2-young-generation-yg">2. <strong>Young Generation (YG)</strong></a></li>
<li><a href="#3-old-generation-tenured">3. <strong>Old Generation (Tenured)</strong></a></li>
<li><a href="#4-stack">4. <strong>Stack</strong></a></li>
<li><a href="#5-metaspace-java-8">5. <strong>Metaspace</strong> (Java 8+)</a></li>
<li><a href="#6-program-counter-pc-register">6. <strong>Program Counter (PC) Register</strong></a></li>
<li><a href="#7-native-method-stack">7. <strong>Native Method Stack</strong></a></li>
<li><a href="#-summary-table">✅ Summary Table</a></li>
<li><a href="#jvm-memory-areas-explained">JVM Memory Areas Explained</a></li>
<li><a href="#string-literal-vs-string-object">String Literal vs String Object</a></li>
<li>[String Manipulation: <code>concat()</code> vs <code>+</code> Operator](#string-manipulation-concat-vs--operator)</li>
<li><a href="#deep-copy-vs-shallow-copy">Deep Copy vs Shallow Copy</a></li>
<li><a href="#why-is-string-immutable-in-java">Why is String Immutable in Java?</a></li>
<li><a href="#creating-an-immutable-class-in-java">Creating an Immutable Class in Java</a></li>
<li><a href="#creating-a-singleton-class-in-java">Creating a Singleton Class in Java</a></li>
<li><a href="#wrapper-classes-and-autoboxing">Wrapper Classes and Autoboxing</a></li>
<li><a href="#-1-definition">🔹 <strong>1. Definition</strong></a></li>
<li><a href="#-2-why-wrapper-classes-exist">🔹 <strong>2. Why Wrapper Classes Exist</strong></a></li>
<li><a href="#-3-auto-boxing--unboxing">🔹 <strong>3. Auto-Boxing &amp; Unboxing</strong></a></li>
<li><a href="#-4-example--boolean-vs-boolean">🔹 <strong>4. Example — boolean vs Boolean</strong></a></li>
<li><a href="#-5-key-differences-summary">🔹 <strong>5. Key Differences Summary</strong></a></li>
<li><a href="#-in-short">🧠 <strong>In short</strong></a></li>
<li><a href="#autoboxing">Autoboxing</a></li>
<li><a href="#example-custom-wrapper-class-demonstrating-autoboxing">Example Custom Wrapper Class Demonstrating Autoboxing</a></li>
<li><a href="#stackoverflow---due-to-out-of-memory">StackOverflow - Due to out of memory</a></li>
<li><a href="#object-oriented-programming-oop-in-java">Object-Oriented Programming (OOP) in Java</a></li>
<li><a href="#1-polymorphism">1. Polymorphism</a></li>
<li><a href="#definition">Definition</a></li>
<li><a href="#inheritance-vs-polymorphism">Inheritance vs Polymorphism</a></li>
...
<li><a href="#covariant-return-type">Covariant Return Type</a></li>
<li><a href="#overriding-restrictions-on-private-static-final-methods">Overriding Restrictions on private, static, final methods</a></li>
<li><a href="#overloading-allowed-for-private-static-final-methods-within-same-class">Overloading allowed for private, static, final methods within same class</a></li>
<li><a href="#data-binding-in-java">Data Binding in Java</a></li>
<li><a href="#2-inheritance">2. Inheritance</a></li>
<li><a href="#3-encapsulation">3. Encapsulation</a></li>
<li><a href="#4-abstraction">4. Abstraction</a></li>
<li><a href="#5-interface">5. Interface</a></li>
<li><a href="#private-methods-in-interface">Private methods in interface</a></li>
<li><a href="#variables-in-interfaces">Variables in Interfaces</a></li>
<li><a href="#class-inside-interface">Class inside Interface</a></li>
<li><a href="#interface-inside-class">Interface inside Class</a></li>
<li><a href="#marker-interface-vs-functional-interface">Marker Interface vs Functional Interface</a></li>
<li><a href="#common-functional-interfaces-and-marker-interfaces">Common Functional Interfaces and Marker Interfaces</a></li>
<li><a href="#java-8-interface-enhancements">Java 8+ Interface Enhancements</a></li>
<li>[6. Functional Interfaces in Java (<code>java.util.function</code>)](#6-functional-interfaces-in-java-javautilfunction)</li>
<li><a href="#7-comparable-vs-comparator">7. Comparable vs Comparator</a></li>
<li>[8. <code>implements</code> vs <code>extends</code>](#8-implements-vs-extends)</li>
<li><a href="#9-interface-vs-abstract-class">9. Interface vs Abstract Class</a></li>
<li><a href="#why-use-interface-over-abstract-class">Why use interface over abstract class?</a></li>
<li><a href="#10-cohesion-vs-coupling">10. Cohesion vs Coupling</a></li>
<li><a href="#coupling">Coupling</a></li>
<li><a href="#cohesion">Cohesion</a></li>
<li><a href="#association-aggregation-and-composition-is-a--has-a">Association, Aggregation, and Composition (IS-A / HAS-A)</a></li>
<li><a href="#-1-what-is-an-is-a-relationship">🧩 1. What is an “IS-A” relationship?</a></li>
<li><a href="#-example-1">➡️ Example</a></li>
<li><a href="#-conceptually">🧠 Conceptually:</a></li>
<li><a href="#-ascii-diagram">🪶 ASCII diagram:</a></li>
<li><a href="#-2-what-is-a-has-a-relationship">🧩 2. What is a “HAS-A” relationship?</a></li>
<li><a href="#-example-2">➡️ Example</a></li>
<li><a href="#-conceptually-1">🧠 Conceptually:</a></li>
<li><a href="#-ascii-diagram-1">🪶 ASCII diagram:</a></li>
<li><a href="#-summary-table-1">⚖️ Summary Table</a></li>
<li><a href="#-has-a-relationship-types-in-java">🧩 HAS-A Relationship Types in Java</a></li>
<li><a href="#-1-composition--strong-has-a-relationship">⚙️ 1. Composition — <em>Strong HAS-A relationship</em></a></li>
<li><a href="#-example-car-has-an-engine">➡️ Example: Car <strong>has</strong> an Engine</a></li>
<li><a href="#-ascii-diagram-2">🪶 ASCII Diagram</a></li>
<li><a href="#-2-aggregation--weak-has-a-relationship">⚙️ 2. Aggregation — <em>Weak HAS-A relationship</em></a></li>
<li><a href="#-example-department-has-employees">➡️ Example: Department <strong>has</strong> Employees</a></li>
<li><a href="#-ascii-diagram-3">🪶 ASCII Diagram</a></li>
<li><a href="#-quick-comparison-table">🧠 Quick Comparison Table</a></li>
<li><a href="#-summary-diagram-all-relationships">🧩 Summary Diagram (All Relationships)</a></li>
<li><a href="#summary">Summary</a></li>
<li><a href="#-java-collections-framework-guide">🧱 Java Collections Framework Guide</a></li>
<li><a href="#-why-collections-framework">🔍 Why Collections Framework?</a></li>
<li><a href="#-collections-hierarchy-overview">🌐 Collections Hierarchy Overview</a></li>
<li><a href="#-interactive-decision-flowchart-pick-the-right-collection">🧭 Interactive Decision Flowchart: Pick the Right Collection</a></li>
<li><a href="#-example-scenarios">🧠 Example Scenarios</a></li>
<li><a href="#1-you-need-to-store-data-with-keys-and-values-and-want-to-sort-them-by-keys">1. You need to store data with keys and values and want to sort them by keys:</a></li>
<li><a href="#2-you-want-to-store-a-list-of-names-with-duplicates-and-access-by-index">2. You want to store a list of names with duplicates and access by index:</a></li>
<li><a href="#3-you-want-to-store-a-set-of-unique-cities-and-order-doesnt-matter">3. You want to store a set of unique cities, and order doesn’t matter:</a></li>
<li><a href="#4-you-want-to-store-key-value-pairs-with-insertion-order-preserved-and-need-thread-safety">4. You want to store key-value pairs with insertion order preserved and need thread safety:</a></li>
<li><a href="#-summary-table-2">🧰 Summary Table</a></li>
<li><a href="#-core-interfaces-and-key-differences">🛠 Core Interfaces and Key Differences</a></li>
<li><a href="#iterable-vs-collection">Iterable vs Collection</a></li>
<li><a href="#iterator-vs-enumeration">Iterator vs Enumeration</a></li>
<li><a href="#collection-interface-methods">Collection Interface Methods</a></li>
<li><a href="#iterator-interface">Iterator Interface</a></li>
<li><a href="#iterable-interface">Iterable Interface</a></li>
<li><a href="#-list-implementations">🧩 List Implementations</a></li>
<li><a href="#arraylist">ArrayList</a></li>
<li><a href="#linkedlist">LinkedList</a></li>
<li><a href="#vector-legacy">Vector (Legacy)</a></li>
<li><a href="#stack-legacy">Stack (Legacy)</a></li>
<li><a href="#-queue-implementations">🌀 Queue Implementations</a></li>
<li><a href="#-set-implementations">🎯 Set Implementations</a></li>
<li><a href="#hashset">HashSet</a></li>
<li><a href="#linkedhashset">LinkedHashSet</a></li>
<li><a href="#treeset">TreeSet</a></li>
<li><a href="#-map-implementations">🧮 Map Implementations</a></li>
<li>[🔑 <strong>Key Differences Between <code>HashMap</code> and <code>Hashtable</code></strong>](#-key-differences-between-hashmap-and-hashtable)</li>
<li><a href="#-when-to-use">✅ <strong>When to Use</strong></a></li>
<li><a href="#-example-3">📌 Example</a></li>
<li><a href="#-thread-safety-comparison">🧠 Thread Safety Comparison</a></li>
<li>[🧠 <code>hashCode()</code> and <code>equals()</code> in Hash-Based Collections](#-hashcode-and-equals-in-hash-based-collections)</li>
<li>[<strong>When to override <code>hashCode()</code> and <code>equals()</code></strong>](#when-to-override-hashcode-and-equals)</li>
<li><a href="#rules"><strong>Rules</strong></a></li>
<li><a href="#when-you-dont-need-them"><strong>When you don’t need them</strong></a></li>
<li><a href="#how-it-works"><strong>How it works</strong></a></li>
<li><a href="#example-2"><strong>Example</strong></a></li>
<li><a href="#-what-is-treeify-and-threshold">🔁 What Is Treeify and Threshold?</a></li>
<li><a href="#-final-full-ascii-diagram-with-treeify-and-threshold">🧩 Final Full ASCII Diagram with Treeify and Threshold</a></li>
<li><a href="#-behind-the-scenes-key-conditions">⚙️ Behind the Scenes: Key Conditions</a></li>
<li><a href="#-quick-summary-table">📊 Quick Summary Table</a></li>
<li><a href="#-how-it-helps">🧪 How It Helps</a></li>
<li><a href="#-final-notes">✅ Final Notes</a></li>
<li><a href="#-imagine-this-first">🧠 Imagine This First...</a></li>
<li><a href="#-key-concepts-simple-terms">🔍 Key Concepts (Simple Terms)</a></li>
<li><a href="#-flow-of-how-hashmap-works-step-by-step">🔄 Flow of How HashMap Works (Step-by-Step)</a></li>
<li><a href="#lets-say">Let&#x27;s say:</a></li>
<li><a href="#step-1-key-is-hashed">Step 1: <strong>Key is Hashed</strong></a></li>
<li><a href="#step-2-find-the-right-bucket">Step 2: <strong>Find the Right Bucket</strong></a></li>
<li><a href="#step-3-handle-collisions-chaining">Step 3: <strong>Handle Collisions (Chaining)</strong></a></li>
<li><a href="#step-4-retrieving-a-value-get-method">Step 4: <strong>Retrieving a Value (get method)</strong></a></li>
<li><a href="#-ascii-diagram-internal-working-of-hashmap">🧱 ASCII Diagram: Internal Working of HashMap</a></li>
<li><a href="#-if-theres-a-collision">🔁 If there&#x27;s a collision:</a></li>
<li><a href="#-internally-technical-but-simple">⚙️ Internally (Technical, but simple)</a></li>
<li><a href="#-summary-even-simpler">📌 Summary (Even Simpler)</a></li>
<li><a href="#-what-is-concurrenthashmap">🧠 What Is ConcurrentHashMap?</a></li>
<li><a href="#-why-use-it">✅ Why Use It?</a></li>
<li><a href="#-how-it-differs-from-hashmap">🔍 How It Differs from HashMap</a></li>
<li><a href="#-internal-working-java-8-and-above">⚙️ Internal Working (Java 8 and above)</a></li>
<li><a href="#-core-concepts">🔩 Core Concepts:</a></li>
<li><a href="#-insertion-flow-put-operation">🔄 Insertion Flow (Put Operation)</a></li>
<li><a href="#-ascii-diagram-of-concurrenthashmap-simplified">🧱 ASCII Diagram of ConcurrentHashMap (Simplified)</a></li>
<li><a href="#-read-operation-get">🧪 Read Operation (Get)</a></li>
<li><a href="#-treeification--resizing">🔐 Treeification &amp; Resizing</a></li>
<li><a href="#-what-it-doesnt-do">🚨 What It Doesn’t Do</a></li>
<li><a href="#-when-to-use-concurrenthashmap">✅ When to Use ConcurrentHashMap</a></li>
<li><a href="#-summary-1">📌 Summary</a></li>
<li><a href="#1-collectionssynchronizedmapmapk-v">1. Collections.synchronizedMap(Map\&lt;K, V&gt;)</a></li>
<li><a href="#2-concurrenthashmapk-v-">2. ConcurrentHashMap\&lt;K, V&gt;</a></li>
<li><a href="#-key-differences">⚖️ Key Differences</a></li>
<li><a href="#-when-to-use-what">🧭 When to Use What?</a></li>
<li><a href="#-why-concurrenthashmap-disallows-nulls">❗ Why ConcurrentHashMap Disallows Nulls?</a></li>
<li><a href="#-summary-when-to-use-what">🛡️ Summary: When to Use What?</a></li>
<li><a href="#java-collections-framework-overview-java-10---java-21"><strong>Java Collections Framework Overview (Java 1.0 - Java 21)</strong></a></li>
<li><a href="#legend">Legend:</a></li>
<li><a href="#1-what-is-serialization"><strong>1. What is Serialization?</strong></a></li>
<li><a href="#2-why-do-we-need-to-serialize-if-an-object-is-already-in-memory-which-is-bytes-anyway"><strong>2. Why do we need to serialize if an object is already in memory (which is bytes anyway)?</strong></a></li>
<li><a href="#3-why-serialization-is-needed-use-cases"><strong>3. Why Serialization is Needed (Use Cases)</strong></a></li>
<li><a href="#4-analogy"><strong>4. Analogy</strong></a></li>
<li><a href="#marshalingunmarshaling">Marshaling/Unmarshaling</a></li>
<li><a href="#-what-is-marshaling-in-java">🧩 What is <em>Marshaling</em> in Java?</a></li>
<li><a href="#-what-is-unmarshaling">🔄 What is <em>Unmarshaling</em>?</a></li>
<li><a href="#-related-terms">🧠 Related Terms</a></li>
<li><a href="#-examples-of-marshalling-in-java">🧰 Examples of Marshalling in Java</a></li>
<li><a href="#1-java-serialization">1️⃣ Java Serialization</a></li>
<li><a href="#2-jaxb-example-xml-marshalling">2️⃣ JAXB Example (XML Marshalling)</a></li>
<li><a href="#-summary-2">💡 Summary</a></li>
<li><a href="#boxing--autoboxing-primitive--wrapper-object">Boxing &amp; Autoboxing (Primitive → Wrapper Object)</a></li>
<li><a href="#unboxing--auto-unboxing-wrapper-object--primitive">Unboxing &amp; Auto-unboxing (Wrapper Object → Primitive)</a></li>
<li><a href="#why">Why?</a></li>
<li>[<code>final</code> keyword](#final-keyword)</li>
<li>[<code>finally</code> block](#finally-block)</li>
<li>[<code>finalize()</code> method](#finalize-method)</li>
<li><a href="#example-3">Example:</a></li>
<li><a href="#-𝐂𝐚𝐜𝐡𝐢𝐧𝐠-𝐒𝐭𝐫𝐚𝐭𝐞𝐠𝐢𝐞𝐬--𝐁𝐞𝐬𝐭-𝐏𝐫𝐚𝐜𝐭𝐢𝐜𝐞𝐬">⚙️ 𝐂𝐚𝐜𝐡𝐢𝐧𝐠 𝐒𝐭𝐫𝐚𝐭𝐞𝐠𝐢𝐞𝐬 &amp; 𝐁𝐞𝐬𝐭 𝐏𝐫𝐚𝐜𝐭𝐢𝐜𝐞𝐬</a></li>
<li><a href="#caching-in-java">Caching in java</a></li>
<li><a href="#two-types-of-error-">Two types of error:-</a></li>
<li><a href="#exception-handling">Exception Handling</a></li>
<li><a href="#throw-new-and-throws">throw new and throws</a></li>
<li>[<code>throw</code>](#throw)</li>
<li>[<code>throws</code>](#throws)</li>
<li><a href="#checked-and-unchecked-exceptions">Checked and Unchecked Exceptions</a></li>
<li><a href="#1-checked-exceptions">1. <strong>Checked Exceptions</strong></a></li>
<li><a href="#2-unchecked-exceptions">2. <strong>Unchecked Exceptions</strong></a></li>
<li><a href="#try-with-resource--java-7-and-java-9-improvements-">Try with Resource (Java 7 and Java 9 Improvements)</a></li>
<li><a href="#-1-nested-try-catch">⚙️ <strong>1. Nested try-catch</strong></a></li>
<li><a href="#-2-handling-multiple-exceptions">⚙️ <strong>2. Handling multiple exceptions</strong></a></li>
<li><a href="#-quick-summary-table-1">🧠 Quick Summary Table</a></li>
<li><a href="#details-1">&lt;/details&gt;</a></li>
<li><a href="#multithreading">Multithreading</a></li>
<li><a href="#volatile-keyword">Volatile Keyword</a></li>
<li><a href="#scenario-stopping-a-background-thread"><strong>Scenario: Stopping a background thread</strong></a></li>
<li><a href="#example-4"><strong>Example</strong></a></li>
<li>[<strong>Why <code>volatile</code> matters here</strong>](#why-volatile-matters-here)</li>
<li><a href="#key-points"><strong>Key Points</strong></a></li>
<li><a href="#deadlock">Deadlock</a></li>
<li><a href="#-threads--resources">🔹 (threads &amp; resources)</a></li>
<li><a href="#-key-characteristics-of-deadlock">🔹 Key characteristics of Deadlock</a></li>
<li><a href="#-simple-java-example">🔹 Simple Java Example</a></li>
...
<li><a href="#-method-level">🔸 Method-Level</a></li>
...
<li><a href="#-explicit-lock-reentrantlock">🔸 Explicit Lock (ReentrantLock)</a></li>
<li><a href="#-volatile">🔸 volatile</a></li>
<li><a href="#1-threads">1. Threads</a></li>
<li><a href="#2-executorservice">2. ExecutorService</a></li>
<li><a href="#3-completablefuture-java-8">3. CompletableFuture (Java 8+)</a></li>
<li><a href="#4-completablefuture-with-callback">4. CompletableFuture with Callback</a></li>
<li><a href="#5-spring-async">5. Spring @Async</a></li>
<li><a href="#6-virtual-threads-java-21">6. Virtual Threads (Java 21)</a></li>
<li><a href="#-two-separate-concepts">🧩 Two Separate Concepts</a></li>
<li><a href="#-1-synchronous-method">⚙️ 1. Synchronous Method</a></li>
<li><a href="#-2-synchronized-method">🧱 2. Synchronized Method</a></li>
<li><a href="#-3-asynchronous-method">⚡ 3. Asynchronous Method</a></li>
<li><a href="#-4-synchronized-block-inside-a-method">🔒 4. Synchronized Block (Inside a Method)</a></li>
<li><a href="#-5-asynchronous-block-inside-a-method">🚀 5. Asynchronous Block (Inside a Method)</a></li>
<li><a href="#-6-combining-both-synchronized--asynchronous">🔗 6. Combining Both (Synchronized + Asynchronous)</a></li>
<li><a href="#-summary-table-3">🧠 Summary Table</a></li>
<li><a href="#-example-combo">🧩 Example Combo</a></li>
<li><a href="#-synchronized">✅ Synchronized</a></li>
<li><a href="#-non-synchronized">❌ Non-Synchronized</a></li>
<li><a href="#-multithreading-concepts-advanced">🧵 Multithreading Concepts: Advanced</a></li>
<li><a href="#-process-synchronization">🧩 <strong>Process Synchronization</strong></a></li>
<li><a href="#-common-ipc-mechanisms">🔐 Common IPC Mechanisms:</a></li>
<li><a href="#-thread-synchronization">🧵 <strong>Thread Synchronization</strong></a></li>
<li><a href="#-techniques">☑️ Techniques:</a></li>
<li>[1️⃣ <strong>Using <code>Thread</code> Class (Basic)</strong>](#1-using-thread-class-basic)</li>
<li>[2️⃣ <strong>Using <code>Runnable</code> Interface</strong>](#2-using-runnable-interface)</li>
<li>[3️⃣ <strong>Using <code>ExecutorService</code> (Thread Pool)</strong>](#3-using-executorservice-thread-pool)</li>
<li>[4️⃣ <strong>Using <code>CompletableFuture</code> (Java 8+)</strong>](#4-using-completablefuture-java-8)</li>
<li>[🧩 <strong>1️⃣ What is <code>ThreadLocal</code>?</strong>](#-1-what-is-threadlocal)</li>
<li><a href="#-example-4">🔹 Example</a></li>
<li><a href="#-2-how-it-works-internally">⚙️ <strong>2️⃣ How It Works Internally</strong></a></li>
<li><a href="#-3-real-world-use-cases">💼 <strong>3️⃣ Real-World Use Cases</strong></a></li>
<li><a href="#-use-case-1-request-context-in-web-applications">✅ <strong>Use Case 1: Request Context in Web Applications</strong></a></li>
<li><a href="#-use-case-2-database-connection-or-session-management">✅ <strong>Use Case 2: Database Connection or Session Management</strong></a></li>
<li><a href="#-use-case-3-logging-context--tracing">✅ <strong>Use Case 3: Logging Context / Tracing</strong></a></li>
<li><a href="#-use-case-4-thread-specific-formatter--parser">✅ <strong>Use Case 4: Thread-Specific Formatter / Parser</strong></a></li>
<li><a href="#-4-pitfalls--best-practices">⚠️ <strong>4️⃣ Pitfalls &amp; Best Practices</strong></a></li>
<li><a href="#-safe-usage-pattern">✅ Safe usage pattern</a></li>
<li><a href="#-5-summary">🧠 <strong>5️⃣ Summary</strong></a></li>
<li><a href="#-in-a-real-project">🚀 <strong>In a Real Project</strong></a></li>
<li>[🧵 1️⃣ Using <code>Thread</code> + <code>wait/notify</code>](#-1-using-thread--waitnotify)</li>
<li>[⚙️ 2️⃣ Using <code>ExecutorService</code> + <code>Lock</code> + <code>Condition</code>](#-2-using-executorservice--lock--condition)</li>
<li><a href="#-design-patterns-in-java">🧩 Design Patterns in Java</a></li>
...
<li><a href="#summary-1">Summary</a></li>
<li><a href="#tabular-comparison">Tabular Comparison</a></li>
<li><a href="#example-with-warning">Example with warning:</a></li>
<li><a href="#suppressing-warnings">Suppressing warnings:</a></li>
<li><a href="#notes">Notes:</a></li>
<li><a href="#1-trigonometric">1. Trigonometric:</a></li>
<li><a href="#2-exponential--logarithmic">2. Exponential / Logarithmic:</a></li>
<li><a href="#3-power--root">3. Power / Root:</a></li>
<li><a href="#4-rounding">4. Rounding:</a></li>
<li><a href="#5-misc">5. Misc:</a></li>
<li><a href="#mathmax">Math.max():</a></li>
<li><a href="#mathmin">Math.min():</a></li>
<li><a href="#26-what-is-the-difference-between-install-and-deploy">26. What is the difference between install and deploy</a></li>
<li><a href="#-question">⚙️ <strong>Question:</strong></a></li>
<li><a href="#-1-the-basics">🧩 <strong>1️⃣ The Basics</strong></a></li>
<li><a href="#-example-5">🔹 Example</a></li>
<li><a href="#-example-6">🔹 Example</a></li>
<li><a href="#builder-style">Builder Style:</a></li>
<li><a href="#record-style">Record Style:</a></li>
<li>[<strong>1️⃣ What happens if you override <code>hashCode()</code> but not <code>equals()</code>?</strong>](#1-what-happens-if-you-override-hashcode-but-not-equals)</li>
<li><a href="#-explanation">💡 Explanation</a></li>
<li><a href="#-effect">⚠️ Effect</a></li>
<li><a href="#-example-7">✅ Example:</a></li>
<li><a href="#2-how-does-jvm-handle-method-overloading-and-overriding-internally"><strong>2️⃣ How does JVM handle method overloading and overriding internally?</strong></a></li>
<li><a href="#-overloading-compile-time-polymorphism">🔹 <strong>Overloading</strong> (compile-time polymorphism)</a></li>
<li><a href="#-overriding-runtime-polymorphism">🔹 <strong>Overriding</strong> (runtime polymorphism)</a></li>
<li><a href="#-short-answer">✅ <strong>Short Answer:</strong></a></li>
<li><a href="#-detailed-explanation">🔍 <strong>Detailed Explanation</strong></a></li>
<li><a href="#1-what-determines-overriding">1️⃣ What determines overriding?</a></li>
<li>[2️⃣ What does <code>@Override</code> actually do?](#2-what-does-override-actually-do)</li>
<li><a href="#3-why-it-matters">3️⃣ Why it matters</a></li>
<li><a href="#-special-cases">⚠️ <strong>Special Cases</strong></a></li>
<li><a href="#-in-summary">🧠 <strong>In summary</strong></a></li>
<li><a href="#-takeaway">✅ <strong>Takeaway</strong></a></li>
<li>[<strong>3️⃣ Difference between <code>final</code>, effectively final, and <code>const</code></strong>](#3-difference-between-final-effectively-final-and-const)</li>
<li><a href="#example-5">Example:</a></li>
<li><a href="#4-pass-by-value-vs-reference-in-java"><strong>4️⃣ Pass-by-value vs. reference in Java</strong></a></li>
<li><a href="#-explanation-1">💡 Explanation</a></li>
<li><a href="#example-6">Example:</a></li>
<li>[<strong>5️⃣ Implement an immutable list without using <code>Collections.unmodifiableList()</code></strong>](#5-implement-an-immutable-list-without-using-collectionsunmodifiablelist)</li>
<li><a href="#-example-8">✅ Example:</a></li>
<li><a href="#6-how-does-the-forkjoinpool-work-internally"><strong>6️⃣ How does the ForkJoinPool work internally?</strong></a></li>
<li><a href="#-concept">💡 Concept</a></li>
<li><a href="#-internal-mechanics">⚙️ Internal Mechanics</a></li>
<li><a href="#-example-9">✅ Example</a></li>
<li>[<strong>7️⃣ Difference between <code>synchronized</code>, <code>Lock</code>, and <code>StampedLock</code></strong>](#7-difference-between-synchronized-lock-and-stampedlock)</li>
<li><a href="#-example-10">🧩 Example</a></li>
<li><a href="#8-completablefuture-vs-traditional-future"><strong>8️⃣ CompletableFuture vs. traditional Future</strong></a></li>
<li><a href="#-example-11">✅ Example</a></li>
<li><a href="#9-design-a-concurrent-cache-with-read-write-locks"><strong>9️⃣ Design a concurrent cache with Read-Write Locks</strong></a></li>
<li><a href="#-goal">💡 Goal</a></li>
<li><a href="#-example-implementation">✅ Example Implementation</a></li>
<li><a href="#-optimization">🚀 Optimization</a></li>
<li><a href="#-false-sharing-and-how-to-avoid-it"><strong>🔟 False Sharing and How to Avoid It</strong></a></li>
<li><a href="#-concept-1">💡 Concept</a></li>
<li><a href="#-example-12">🔍 Example</a></li>
<li><a href="#-effect-1">🚫 Effect</a></li>
<li><a href="#-avoidance-techniques">✅ Avoidance Techniques</a></li>
<li><a href="#-summary-table-4">✅ <strong>Summary Table</strong></a></li>
<li><a href="#junit">Junit</a></li>
<li><a href="#junit-mockito">Junit mockito</a></li>
<li><a href="#java-questions">Java Questions</a></li>
</ul>
<h1 id="java-interview-question-bank">Java Interview Question Bank</h1>
<ul>
